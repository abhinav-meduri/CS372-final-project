...
Note: Features were optimized based on ablation study results (10 features used).
"""
...
class FeatureExtractor:
    ...
    # Feature names in order (10 features after ablation study)
    FEATURE_NAMES = [
    ...
    # Base features only (11 features used in PyTorch model)
    BASE_FEATURE_NAMES = [
        'cosine_doc_similarity',
        'cosine_max_claim_similarity',
        'embedding_diff_mean',
    ...
    def compute_cpc_jaccard(self, patent1: dict, patent2: dict) -> float:
        """CPC feature removed per ablation study."""
    ...
    def extract_features(
        ...
        # Compute claim similarity (using cosine similarity of first claims as proxy)
        # This is a simplified version - full claim similarity would use claim_embeddings.py
        claim_sim = cosine_sim  # Using doc similarity as proxy for claim similarity
        ...
        features = {
            ...
            # Claim similarity (most important feature per ablation study)
